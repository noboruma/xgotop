...
#error "This BPF program is only supported on arm64 and x86_64"
#endif

#if defined(bpf_target_arm64)
#define __GO_G_ADDR(ctx) (__PT_REGS_CAST(ctx)->regs[28])
#elif defined(bpf_target_x86)
#define __GO_G_ADDR(ctx) (__PT_REGS_CAST(ctx)->r14)
#endif
...
//
// // Source:
// https://github.com/pixie-io/pixie/blob/a95d6617f17e374ff0a79b1a49fc1abc2ca0023a/src/stirling/source_connectors/socket_tracer/bcc_bpf/go_trace_common.h#L94
// //
...
#define SEND_EVENT_WITH_SAMPLING(EVENT_TYPE, G_ID, G_PARENT_ID, ATTR0, ATTR1, ATTR2, ATTR3, ATTR4, \
                                 START_NS_U64)                                                     \
    do {                                                                                           \
...
__always_inline static int get_go_g_struct(struct pt_regs *ctx, struct go_runtime_g *g) {
    u64 g_addr = __GO_G_ADDR(ctx);
#ifdef BPF_DEBUG
    bpf_printk("get_go_g_struct: g_addr=%llu", g_addr);
#endif
    return bpf_probe_read(g, sizeof(*g), (void *)g_addr);
}
